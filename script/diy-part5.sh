...
sed -i 's/$hostname-2.4G/666/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
sed -i 's/OpenWRT-2.4G/666/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
...
sed -i 's/$hostname-5G/666-5G/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
sed -i 's/OpenWRT-5G/666-5G/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
